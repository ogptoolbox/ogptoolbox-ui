module Properties.KeysAutocomplete.View exposing (..)
...
viewAutocomplete language parentId controlLabelI18n controlPlaceholderI18n error model =
    let
        ...
        controlFindAnother =
            I18n.translate language I18n.FindAnotherPropertyKey

        controlFindOne =
            I18n.translate language I18n.FindPropertyKey
        ...
        controlSelectOneOrTypeMoreCharacters =
            I18n.translate language I18n.SelectPropertyKeyOrTypeMoreCharacters

        controlTitle =
            I18n.translate language I18n.EnterPropertyKey
                                        ...
                                        span [ class "input-group-btn" ]
                                            [ button
                                                ...
                                                , onWithOptions "click"
                                                    { preventDefault = True, stopPropagation = False }
                                                    (Json.Decode.succeed
                                                        (ForParent (Create model.autocomplete))
                                                    )
                                                ]
...
viewAutocompleteItemContent keyAutocompletion =
    [ Html.text keyAutocompletion.autocomplete ]
